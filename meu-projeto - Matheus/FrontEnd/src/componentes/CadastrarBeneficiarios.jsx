...
function CadastrarBeneficiarios() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Erro ao salvar beneficiário. Tente novamente.");
    }
  };
  ...
  const editarBeneficiario = (beneficiario) => {
    // Usa os campos exatos do objeto, sem mapeamento
    const novosDados = {
  ...
  const validarFormulario = () => {
    ...
    if (!formData.rg || rgSemMascara.length < 7 || rgSemMascara.length > 9) {
      novosErros.rg = "RG deve ter entre 7 e 9 dígitos";
    }
